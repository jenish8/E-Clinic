...
import {MenuItems3} from '../../shared/menu-items/menu-items3';
...
export class AdminComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    console.log("Getting User Type :-", this.userType);
    // if(this.panel == "Admin Panel"){
    //   this.router.navigate(['/dashboard']);
    // }
    this.user_name = localStorage.getItem("user_name");
    console.log("getting UserMaster :-", this.userMaster);
   }
